...
public class MainItemOrder {
  private MainCatalogItem item;
  private int numItems;

  public MainItemOrder(MainCatalogItem item) {
    setItem(item);
    setNumItems(1);
  }

  public MainCatalogItem getItem() {
    return(item);
  }

  protected void setItem(MainCatalogItem item) {
    this.item = item;
  }
