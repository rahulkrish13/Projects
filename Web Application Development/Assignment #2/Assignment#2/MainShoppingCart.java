...
public class MainShoppingCart {
  ...
  public synchronized void addItem(String itemID) {
    ...
    MainItemOrder newOrder = new MainItemOrder(Catalog.getItem(itemID));
  ...
  public synchronized void setNumOrdered(String itemID,
    ...
    MainItemOrder newOrder =
      new MainItemOrder(Catalog.getItem(itemID));
    itemsOrdered.add(newOrder);
  }
}
