...
def dataset_1KB():
    ...
    for i in range(100,200):
            filesize = 0
            while filesize < (1000):
                filecreate = open("1KB_dataset/1KB_fda"+str(i)+".txt","a")
                word = gen_word(99)
                filecreate.write(word+"\n")
                filecreate.close()
                fileinfo = os.stat("1KB_dataset/1KB_fda"+str(i)+".txt")
...
def dataset_10KB():
    ...
    for i in range(100,200):
            ...
            while filesize < (10200):
                filecreate = open("10KB_dataset/10KB_fd"+str(i)+".txt","a")
                word = gen_word(99)
                filecreate.write(word+"\n")
                filecreate.close()
                fileinfo = os.stat("10KB_dataset/10KB_fd"+str(i)+".txt")
                filesize = fileinfo.st_size
            filecreate = open("10KB_dataset/10KB_fd"+str(i)+".txt","a")
            word = gen_word(40)
            filecreate.write(word)
...
def dataset_100KB():
    ...
    for i in range(100,200):        
        ...
        while filesize < (102400):
            filecreate = open("100KB_dataset/100KB_f"+str(i)+".txt","a")
            word = gen_word(99)
            filecreate.write(word+"\n")
            filecreate.close()
            fileinfo = os.stat("100KB_dataset/100KB_f"+str(i)+".txt")
            filesize = fileinfo.st_size
...
def dataset_1MB():
    ...
    for i in range(100,200):        
        ...
        while filesize < (1048500):
            filecreate = open("1MB_dataset/1MB_fda"+str(i)+".txt","a")
            word = gen_word(99)
            filecreate.write(word+"\n")
            filecreate.close()
            fileinfo = os.stat("1MB_dataset/1MB_fda"+str(i)+".txt")
            filesize = fileinfo.st_size
        filecreate = open("1MB_dataset/1MB_fda"+str(i)+".txt","a")
        word = gen_word(76)
        filecreate.write(word)
...
def dataset_10MB():
    ...
    for i in range(10,20):        
        ...
        while filesize < (10485700):
            filecreate = open("10MB_dataset/10MB_fda"+str(i)+".txt","a")
            word = gen_word(99)
            filecreate.write(word+"\n")
            filecreate.close()
            fileinfo = os.stat("10MB_dataset/10MB_fda"+str(i)+".txt")
            filesize = fileinfo.st_size
        filecreate = open("10MB_dataset/10MB_fda"+str(i)+".txt","a")
        word = gen_word(60)
        filecreate.write(word)
...
def dataset_100MB():
    ...
    for i in range(1,2):
        ...
        while filesize < (104857600):
            filecreate = open("100MB_dataset/100MB_fda"+str(i)+".txt","a")
            word = gen_word(99)
            filecreate.write(word+"\n")
            filecreate.close()
            fileinfo = os.stat("100MB_dataset/100MB_fda"+str(i)+".txt")
            filesize = fileinfo.st_size
